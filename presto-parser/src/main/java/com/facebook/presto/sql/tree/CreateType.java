        ...
        extends Statement
{
    ...
    public CreateType(QualifiedName typeName, Optional<String> distinctType, List<String> parameterNames, List<String> parameterTypes)
    {
        ...
        for (int i = 0; i < parameterNames.size(); i++) {
            ...
            checkArgument(!parameterNamesSet.contains(parameterName), format("Type %s has multiple parameters for %s", typeName, parameterType));
