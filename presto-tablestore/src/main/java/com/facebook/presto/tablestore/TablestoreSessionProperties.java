...
public class TablestoreSessionProperties
{
    ...
    public static final String HINT_INDEX_FIRST = TablestoreConnectorId.TABLESTORE_CONNECTOR + "-index-first";
    ...
    protected static IndexFirstSet extractIndexFirst(ConnectorSession session)
    {
        String string = getFromConnectorSession(session, HINT_INDEX_FIRST, String.class, (k, v) -> v, b -> true);
        return IndexFirstSet.parseSearchIndexFirst(Optional.empty(), HINT_INDEX_FIRST, string);
    }
