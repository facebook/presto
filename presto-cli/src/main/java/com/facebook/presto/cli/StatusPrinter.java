 ...
 */
    ...
    {
        // TODO: The current implementation of detecting metric type is hacky. If there are more complex use cases, we could consider adding a enum to RuntimeMetric to track its type.
