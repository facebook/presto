...
{
    private static final String SET_THRIFT_IDENTITY_HEADER = "THRIFT_CONNECTOR_SET_IDENTITY_HEADERS";
    ...
    public ThriftSessionProperties(ThriftConnectorConfig config)
    {
        sessionProperties = ImmutableList.of(booleanProperty(
                ...
                "Set to true to set thrift identity. Default false.",
                config.shouldSetIdentityThriftHeaders(),
                false));
    }

    public static boolean shouldSetIdentityThriftHeaders(ConnectorSession session)
    {
