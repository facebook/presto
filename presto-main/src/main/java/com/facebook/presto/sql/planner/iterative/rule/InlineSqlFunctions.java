        ...
        extends ExpressionRewriteRuleSet
{
    ...
    private static ExpressionRewriter createRewrite(Metadata metadata, SqlParser sqlParser)
    {
        ...
        return (expression, context) -> InlineSqlFunctionsRewriter.rewrite(
                ...
                getExpressionTypes(
                        ...
                        metadata,
                        sqlParser,
                        SemanticTypeProvider.copyOf(context.getVariableAllocator().getTypes()),
                        expression,
                        emptyList(),
    ...
    public static class InlineSqlFunctionsRewriter
    {
        ...
        public static Expression rewrite(Expression expression, Session session, Metadata metadata, Map<NodeRef<Expression>, TypeWithName> expressionTypes)
        {
                ...
                extends com.facebook.presto.sql.tree.ExpressionRewriter<Void>
        {
            ...
            public Visitor(Session session, Metadata metadata, Map<NodeRef<Expression>, TypeWithName> expressionTypes)
            {
