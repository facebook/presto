        ...
        extends DefaultTraversalVisitor<Void, Void>
{
    ...
    protected Void visitSingleColumn(SingleColumn node, Void context)
    {
        ...
        materializedViewInfo.addBaseToViewColumn(baseColumnName, viewDerivedColumnName);
        return null;
    }
    ...
    public static final class MaterializedViewInfo
    {
        ...
        private Optional<ImmutableSet<GroupingElement>> groupBy = Optional.empty();
        ...
        private void setGroupBy(Optional<ImmutableSet<GroupingElement>> groupBy)
        {
        ...
        public Optional<ImmutableSet<GroupingElement>> getGroupBy()
        {
            return groupBy;
        }
