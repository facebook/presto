        ...
        implements NodeSelector
{
    ...
    private boolean isTTLEnough(ConfidenceBasedTTLInfo ttlInfo, Duration estimatedExecutionTime)
    {
        ...
        return new Duration(timeRemaining >= 0 ? timeRemaining : 0, TimeUnit.MILLISECONDS).compareTo(estimatedExecutionTime) >= 0;
    }
    ...
    private Duration getEstimatedExecutionTimeRemaining()
    {
        ...
        double estimatedExecutionTimeRemaining = totalEstimatedExecutionTime - elapsedExecutionTime;
